...
int main()
{
    ...
    idAuto = idAuto + harcodearAutos(listaAutos, TAMAUTO, 10);
    idServicio = idServicio + harcodearServicios(listaServicios, TAMSERVICIO, 4);
    idTrabajo = idTrabajo + harcodearTrabajos(listaTrabajos, TAMTRABAJO, 6);
    ...
    do
    {
        ...
        case 'i':
            ...
            break;
        case 'j':
            menuDeInformesCases(listaAutos, TAMAUTO, listaColores, TAMCOLORES, listaMarcas, TAMMARCA, listaTrabajos, TAMTRABAJO, listaServicios, TAMSERVICIO);
            break;
        case 'z':
